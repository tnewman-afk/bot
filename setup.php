...
if (file_exists('git_pull.lock')) {
    sleep(5);
    echo '<!DOCTYPE html><html lang="en" dir="ltr"><head><title>Protector Bot: error</title></head><body><h1>GIT pull in progress - please retry again in a moment</h1></body></html>';
    exit;
}
...
$nlm_tool = "WikipediaProtectorBot";
